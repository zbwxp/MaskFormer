...
from ..transformer.entity_transformer_predictor import EntityTransformerPredictor
from .pixel_decoder import build_pixel_decoder


@SEM_SEG_HEADS_REGISTRY.register()
class EntityMaskFormerHead(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        return {
            ...
            "transformer_predictor": EntityTransformerPredictor(
                cfg,
