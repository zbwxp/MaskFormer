...
from ..transformer.CondInst_transformer_predictor import CondInstTransformerPredictor
...
class CondInstHead(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        return {
            ...
            "transformer_predictor": CondInstTransformerPredictor(
                cfg,
